            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <Link href="/products/lixel-studio" className="group">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all h-full transform hover:-translate-y-1">
                  <div className="h-48 bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-8">
                    <img 
              ...
              <Link href="/products/lixel-cyber-color" className="group">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all h-full transform hover:-translate-y-1">
                  <div className="h-48 bg-gradient-to-br from-purple-50 to-purple-100 flex items-center justify-center p-8">
                    <img 
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-900 group-hover:text-purple-600 font-medium transition-colors flex items-center">
                      詳細を見る 
                      <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
              ...
              <Link href="/products/lixel-go" className="group">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all h-full transform hover:-translate-y-1">
                  <div className="h-48 bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center p-8">
                    <img 
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-900 group-hover:text-green-600 font-medium transition-colors flex items-center">
                      詳細を見る 
                      <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="flex items-center p-6">
                  <div className="w-24 h-24 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl flex items-center justify-center p-4 mr-6">
                    <img 
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="flex items-center p-6">
                  <div className="w-24 h-24 bg-gradient-to-br from-red-50 to-red-100 rounded-xl flex items-center justify-center p-4 mr-6">
                    <img 
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-bold mb-2">Revit プラグイン</h3>
                    <p className="text-gray-600 text-sm mb-3">
                      点群データ直接インポート
                    </p>
                    <div className="flex flex-wrap gap-2">
